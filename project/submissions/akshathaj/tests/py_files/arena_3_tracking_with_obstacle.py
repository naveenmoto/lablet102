# -*- coding: utf-8 -*-
"""arena_3_tracking_with_obstacle

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1xZP-SfH1fNbJQe3qoi-rJ8DQNDSrFXJA
"""
...
data = np.loadtxt("arena_3.map", skiprows=4, dtype='str')
data_header = np.loadtxt("arena_3.map", skiprows=1, max_rows = 2, dtype = 'str')
...
obstacles = np.array([[22, 24, 31, 33],
                       [10, 15, 5, 7]])
grid_modified = place_obstacles(grid,obstacles,extent_limits)
grid_modified_dense = densify_grid(grid_modified)
# plot_environment(grid_modified_dense,extent_limits)
plot_astar(grid_modified_dense,start,goal,astar_path,extent_limits)
...
while path_index < len(astar_path)-1:
    ...
    if euclidean(pose[:2],local_ref_path[-1][:2]) < goal_threshold*4*pred_horizon:
        ...
        local_ref_path = astar_path[path_index:path_index+pred_horizon]
    # get next command
    v, w = track(grid_modified_dense,local_ref_path,pose,v,w)
